...
import app.roque.com.studialquilerapp.fragments.LoginFragment;
...
public class PrincipalActivity extends AppCompatActivity {
    ...
    private int[] tabIcons = {
            R.drawable.ic_home,
            R.drawable.ic_studi_alquiler_white,
            R.drawable.ic_login
    };
    ...
    private void setupViewPager(ViewPager viewPager) {
        ...
        adapter.addFrag(new ListaDeInmueblesFragment(), "INMUEBLES");
        adapter.addFrag(new CentrosEducativosFragment(), "CENTROS");
